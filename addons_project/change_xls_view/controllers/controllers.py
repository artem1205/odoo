...
class CustomTableExplorer(http.Controller):
    ...
    def export_xls(self, data, token):
        ...
        header_bold = xlwt.easyxf(
            "font: bold on; pattern: pattern solid, fore_colour white; borders: left thin, right thin, top thin, bottom thin;")
        ...
        for row in jdata['rows']:
            ...
            for cell in row['values']:
                ...
                if cell.get('is_bold', False):
                    worksheet.write(y, x, cell['value'], header_bold)
                else:
                    worksheet.write(y, x, cell['value'], header_plain)
            x, y = 0, y + 1
    ...
    TableExporter.export_xls = export_xls
